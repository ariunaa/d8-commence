...
$settings['file_private_path'] = '/var/www/html/commencement/private';
...
//$settings['trusted_host_patterns'] = [ '^commencement\.mit\.edu' ];
...
if (empty($config_directories['active']))
    $config_directories['active'] = "sites/default/files/config_acqTmp-2019-11-01T10.22.35-6703/active";
if (empty($config_directories['staging']))
    $config_directories['staging'] = "sites/default/files/config_acqTmp-2019-11-01T10.22.35-6703/staging";

if (empty($settings['hash_salt']))
      $settings['hash_salt'] = 'ZGVmYXVsdAA4OwuNZTg=';
